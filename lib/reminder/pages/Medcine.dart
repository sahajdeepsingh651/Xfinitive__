...
import 'package:xfinitive/reminder/constants.dart';
import 'package:xfinitive/reminder/global_bloc.dart';
import 'package:xfinitive/reminder/models/medicine.dart';
import 'package:xfinitive/reminder/pages/medicine_details/medicine_details.dart';
import 'package:xfinitive/reminder/pages/new_entry/new_entry_page.dart';
...
class ReminderPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {print('Remainder page');
    print('helo');
    return Scaffold(
      appBar: AppBar(
      ...
      context,
      MaterialPageRoute(builder: (context) => HomeScreen(name: '${UserService().userName}',)),
